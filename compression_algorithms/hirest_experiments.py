...
#file = np.load('./../data/sidewalk_permit_final_1024.npy')
#data = file[0:1024,0:1024]

# file = np.fromfile('data/park_final_1024.npy', dtype=float)
# file = file.reshape(1800, 1800)
# data = file[0:1024,0:1024]

# shape = 1024

# nn = MultivariateHierarchical('hier', quantize_thresh = 0.001,window_thresh = 0, blocksize=shape, start_level = 10, trc = True, flattening_algo="row", w=8, pivot_selection='window')
# nn.load(data)
# nn.compress()
# nn.decompress(data) 
